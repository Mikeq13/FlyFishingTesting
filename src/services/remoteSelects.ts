...
export const REMOTE_SHARED_SELECTS = {
  ...
  experiments:
    'id, owner_auth_user_id, local_record_id, session_id, hypothesis, control_focus, rig_setup_json, fly_entries_json, control_fly_json, variant_fly_json, control_casts, control_catches, variant_casts, variant_catches, winner, outcome, status, confidence_score, archived_at',
