...
export const themeRegistry: Record<ThemeId, AppTheme> = {
  default_professional: {
    ...
    colors: {
      bg: '#0a1520',
      surface: 'rgba(8, 18, 27, 0.92)',
      surfaceAlt: 'rgba(13, 31, 43, 0.94)',
      surfaceMuted: 'rgba(255,255,255,0.12)',
      surfaceLight: '#f7fbfd',
      surfaceLightAlt: '#ffffff',
      border: 'rgba(190, 220, 234, 0.28)',
      borderStrong: 'rgba(190, 220, 234, 0.42)',
      ...
      neutral: '#657786',
      danger: '#9b2c2c',
      warningBg: 'rgba(247, 193, 93, 0.3)',
      warningBorder: 'rgba(247, 193, 93, 0.52)',
      warningText: '#fff4d4',
      successBg: 'rgba(47,143,131,0.24)',
      successBorder: 'rgba(47,143,131,0.5)',
      successText: '#edfffb',
      errorBg: 'rgba(155,44,44,0.24)',
      errorBorder: 'rgba(230,124,124,0.5)',
      errorText: '#ffe2e2',
      infoBg: 'rgba(101, 168, 207, 0.26)',
      ...
      modalSurface: 'rgba(10, 24, 35, 0.98)',
      modalSurfaceAlt: 'rgba(15, 35, 48, 0.96)',
  ...
  high_contrast: {
    ...
    colors: {
      bg: '#02070b',
      surface: 'rgba(5, 10, 15, 0.97)',
      surfaceAlt: 'rgba(8, 17, 24, 0.98)',
      ...
      neutral: '#697b89',
      danger: '#c53030',
      warningBg: 'rgba(255, 196, 78, 0.34)',
      warningBorder: 'rgba(255, 196, 78, 0.62)',
      warningText: '#fff8e2',
      successBg: 'rgba(34,199,168,0.3)',
      successBorder: 'rgba(34,199,168,0.58)',
      successText: '#f0fffb',
      errorBg: 'rgba(197,48,48,0.3)',
      errorBorder: 'rgba(255,147,147,0.62)',
      errorText: '#fff0f0',
      infoBg: 'rgba(56, 189, 248, 0.3)',
  ...
  daylight_light: {
    ...
    colors: {
      ...
      surfaceAlt: 'rgba(245,249,251,0.94)',
