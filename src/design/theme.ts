...
export const themeRegistry: Record<ThemeId, AppTheme> = {
  default_professional: {
    ...
    background: {
      ...
      imageOpacity: 0.52,
      overlay: 'rgba(7, 18, 26, 0.76)',
      topGlow: 'rgba(105, 184, 204, 0.05)',
      bottomGlow: 'rgba(45, 79, 109, 0.08)',
  ...
  high_contrast: {
    ...
    background: {
      ...
      imageOpacity: 0.44,
      overlay: 'rgba(1, 6, 10, 0.88)',
      topGlow: 'rgba(125, 211, 252, 0.03)',
      bottomGlow: 'rgba(34, 197, 168, 0.04)',
      texture: 'rgba(255,255,255,0.012)',
      textureBorderTop: 'rgba(255,255,255,0.03)',
      textureBorderBottom: 'rgba(255,255,255,0.02)'
    },
  ...
  daylight_light: {
    ...
    background: {
      ...
      imageOpacity: 0.3,
      overlay: 'rgba(236, 243, 247, 0.8)',
      topGlow: 'rgba(116, 177, 201, 0.05)',
      bottomGlow: 'rgba(70, 130, 156, 0.04)',
      texture: 'rgba(255,255,255,0.0)',
